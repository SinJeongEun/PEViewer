...
bt_list = []               #bounded import directory table
dll_names = []
import_name_table =[]
import_address_table = []
import_hint_and_names = []
image_debug_directory = []
image_load_config_directory = [] #안됨
...
class NTHeader:
    ...
    def optional_header(self, t):        
            ...
            self.part3.append([pFile(t), wORD(hex(struct.unpack('<l', data[t:t+WORD]+b'\x00\x00')[0])), 'Magic', value]); 
            optional_header_list.append([pFile(t), wORD(hex(struct.unpack('<l', data[t:t+WORD]+b'\x00\x00')[0])), 'Magic', value])
            t+=WORD
            self.part3.append([pFile(t), bYTE(hex(struct.unpack('<l', data[t:t+BYTE]+b'\x00\x00\x00')[0])), 'Major Linker Version', '']); 
            optional_header_list.append([pFile(t), bYTE(hex(struct.unpack('<l', data[t:t+BYTE]+b'\x00\x00\x00')[0])), 'Major Linker Version', ''])
            t+=BYTE
            self.part3.append([pFile(t), bYTE(hex(struct.unpack('<l', data[t:t+BYTE]+b'\x00\x00\x00')[0])), 'Minor Linker Version', '']); 
            optional_header_list.append([pFile(t), bYTE(hex(struct.unpack('<l', data[t:t+BYTE]+b'\x00\x00\x00')[0])), 'Minor Linker Version', ''])
            t+=BYTE
            self.part3.append([pFile(t), dWORD(hex(struct.unpack('<l', data[t:t+DWORD])[0])), 'Size of Code', '']); 
            optional_header_list.append([pFile(t), dWORD(hex(struct.unpack('<l', data[t:t+DWORD])[0])), 'Size of Code', ''])
            t+=DWORD
            self.part3.append([pFile(t), dWORD(hex(struct.unpack('<l', data[t:t+DWORD])[0])), 'Size of Initialized Data', '']); 
            optional_header_list.append([pFile(t), dWORD(hex(struct.unpack('<l', data[t:t+DWORD])[0])), 'Size of Initialized Data', ''])
            t+=DWORD
            self.part3.append([pFile(t), dWORD(hex(struct.unpack('<l', data[t:t+DWORD])[0])), 'Size of Uninitialized Data', '']); 
            optional_header_list.append([pFile(t), dWORD(hex(struct.unpack('<l', data[t:t+DWORD])[0])), 'Size of Uninitialized Data', ''])
            t+=DWORD
            self.part3.append([pFile(t), dWORD(hex(struct.unpack('<l', data[t:t+DWORD])[0])), 'Address of Entry Point', '']); 
            optional_header_list.append([pFile(t), dWORD(hex(struct.unpack('<l', data[t:t+DWORD])[0])), 'Address of Entry Point', ''])
            t+=DWORD   
            self.part3.append([pFile(t), dWORD(hex(struct.unpack('<l', data[t:t+DWORD])[0])), 'Base of Code', '']); 
            optional_header_list.append([pFile(t), dWORD(hex(struct.unpack('<l', data[t:t+DWORD])[0])), 'Base of Code', ''])
            t+=DWORD   
            if BIT == 32:
                self.part3.append([pFile(t), dWORD(hex(struct.unpack('<l', data[t:t+DWORD])[0])), 'Base of Data', '']); 
                optional_header_list.append([pFile(t), dWORD(hex(struct.unpack('<l', data[t:t+DWORD])[0])), 'Base of Data', ''])
                t+=DWORD   
                self.part3.append([pFile(t), dWORD(hex(struct.unpack('<l', data[t:t+DWORD])[0])), 'ImageBase', '']); 
                optional_header_list.append([pFile(t), dWORD(hex(struct.unpack('<l', data[t:t+DWORD])[0])), 'ImageBase', ''])
                t+=DWORD       
            elif BIT == 64:
                self.part3.append([pFile(t), dWORD(hex(struct.unpack('<l', data[t:t+DWORD])[0])), 'ImageBase', '']); 
                optional_header_list.append([pFile(t), dWORD(hex(struct.unpack('<l', data[t:t+DWORD])[0])), 'ImageBase', ''])
                t+=DWORD   
                self.part3.append([pFile(t), dWORD(hex(struct.unpack('<l', data[t:t+DWORD])[0])), '', '']); 
                optional_header_list.append([pFile(t), dWORD(hex(struct.unpack('<l', data[t:t+DWORD])[0])), '', ''])
                t+=DWORD 
            self.part3.append([pFile(t), dWORD(hex(struct.unpack('<l', data[t:t+DWORD])[0])), 'Section Alignment', '']); 
            optional_header_list.append([pFile(t), dWORD(hex(struct.unpack('<l', data[t:t+DWORD])[0])), 'Section Alignment', ''])
            t+=DWORD  
            self.part3.append([pFile(t), dWORD(hex(struct.unpack('<l', data[t:t+DWORD])[0])), 'File Alignment', '']); 
            optional_header_list.append([pFile(t), dWORD(hex(struct.unpack('<l', data[t:t+DWORD])[0])), 'File Alignment', ''])
            t+=DWORD 
            self.part3.append([pFile(t), wORD(hex(struct.unpack('<l', data[t:t+WORD]+b'\x00\x00')[0])), 'Major O/S Version', '']); 
            optional_header_list.append([pFile(t), wORD(hex(struct.unpack('<l', data[t:t+WORD]+b'\x00\x00')[0])), 'Major O/S Version', ''])
            t+=WORD
            self.part3.append([pFile(t), wORD(hex(struct.unpack('<l', data[t:t+WORD]+b'\x00\x00')[0])), 'Minor O/S Version', '']); 
            optional_header_list.append([pFile(t), wORD(hex(struct.unpack('<l', data[t:t+WORD]+b'\x00\x00')[0])), 'Minor O/S Version', ''])
            t+=WORD
            self.part3.append([pFile(t), wORD(hex(struct.unpack('<l', data[t:t+WORD]+b'\x00\x00')[0])), 'Major Image Version', '']); 
            optional_header_list.append([pFile(t), wORD(hex(struct.unpack('<l', data[t:t+WORD]+b'\x00\x00')[0])), 'Major Image Version', ''])
            t+=WORD
            self.part3.append([pFile(t), wORD(hex(struct.unpack('<l', data[t:t+WORD]+b'\x00\x00')[0])), 'Minor Image Version', '']); 
            optional_header_list.append([pFile(t), wORD(hex(struct.unpack('<l', data[t:t+WORD]+b'\x00\x00')[0])), 'Minor Image Version', ''])
            t+=WORD
            self.part3.append([pFile(t), wORD(hex(struct.unpack('<l', data[t:t+WORD]+b'\x00\x00')[0])), 'Major Subsystem Version', '']); 
            optional_header_list.append([pFile(t), wORD(hex(struct.unpack('<l', data[t:t+WORD]+b'\x00\x00')[0])), 'Major Subsystem Version', ''])
            t+=WORD
            self.part3.append([pFile(t), wORD(hex(struct.unpack('<l', data[t:t+WORD]+b'\x00\x00')[0])), 'Minor Subsystem Version', '']); 
            optional_header_list.append([pFile(t), wORD(hex(struct.unpack('<l', data[t:t+WORD]+b'\x00\x00')[0])), 'Minor Subsystem Version', ''])
            t+=WORD
            self.part3.append([pFile(t), dWORD(hex(struct.unpack('<l', data[t:t+DWORD])[0])), 'Win32 Version Value', '']); 
            optional_header_list.append([pFile(t), dWORD(hex(struct.unpack('<l', data[t:t+DWORD])[0])), 'Win32 Version Value', ''])
            t+=DWORD 
            self.part3.append([pFile(t), dWORD(hex(struct.unpack('<l', data[t:t+DWORD])[0])), 'Size Of Image', '']); 
            optional_header_list.append([pFile(t), dWORD(hex(struct.unpack('<l', data[t:t+DWORD])[0])), 'Size Of Image', ''])
            t+=DWORD 
            self.part3.append([pFile(t), dWORD(hex(struct.unpack('<l', data[t:t+DWORD])[0])), 'Size Of Headers', '']); 
            optional_header_list.append([pFile(t), dWORD(hex(struct.unpack('<l', data[t:t+DWORD])[0])), 'Size Of Headers', ''])
            t+=DWORD 
            self.part3.append([pFile(t), dWORD(hex(struct.unpack('<l', data[t:t+DWORD])[0])), 'Checksum', '']); 
            optional_header_list.append([pFile(t), dWORD(hex(struct.unpack('<l', data[t:t+DWORD])[0])), 'Checksum', ''])
            t+=DWORD
            ...
            self.part3.append([pFile(t), wORD(hex(struct.unpack('<l', data[t:t+WORD]+b'\x00\x00')[0])), 'Subsystem', 
                               subSystemValue[byteToInt(data[t:t+WORD]+b'\x00\x00')]]); 
            optional_header_list.append([pFile(t), wORD(hex(struct.unpack('<l', data[t:t+WORD]+b'\x00\x00')[0])), 'Subsystem', 
                               subSystemValue[byteToInt(data[t:t+WORD]+b'\x00\x00')]])
            t+=WORD
            dllChar = byteToInt(data[t:t+WORD]+b'\x00\x00')
            self.part3.append([pFile(t), wORD(hex(struct.unpack('<l', data[t:t+WORD]+b'\x00\x00')[0])), 'Dll characteries', '']); 
            optional_header_list.append([pFile(t), wORD(hex(struct.unpack('<l', data[t:t+WORD]+b'\x00\x00')[0])), 'Dll characteries', ''])
            t+=WORD
            ...
            if dllChar & 0x0020:
                ...
                optional_header_list.append(['','' , "%04x"%(int("0x0020",16)), DllCharaEnt[0]])
            if dllChar & 0x0040:
                self.part3.append(['','' , "%04x"%(int("0x0040",16)), DllCharaEnt[1]])
                optional_header_list.append(['','' , "%04x"%(int("0x0040",16)), DllCharaEnt[1]])
            if dllChar & 0x0080:
                self.part3.append(['','' , "%04x"%(int("0x0080",16)), DllCharaEnt[2]])
                optional_header_list.append(['','' , "%04x"%(int("0x0080",16)), DllCharaEnt[2]])
                
            if dllChar & 0x0100:
                self.part3.append(['','' , "%04x"%(int("0x0100",16)), DllCharaEnt[3]])
                optional_header_list.append(['','' , "%04x"%(int("0x0100",16)), DllCharaEnt[3]])
            if dllChar & 0x0200:
                self.part3.append(['','' , "%04x"%(int("0x0200",16)), DllCharaEnt[4]])
                optional_header_list.append(['','' , "%04x"%(int("0x0200",16)), DllCharaEnt[4]])
            if dllChar & 0x0400:
                self.part3.append(['','' , "%04x"%(int("0x0400",16)), DllCharaEnt[5]])
                optional_header_list.append(['','' , "%04x"%(int("0x0400",16)), DllCharaEnt[5]])
            if dllChar & 0x0800:
                self.part3.append(['','' , "%04x"%(int("0x0800",16)), DllCharaEnt[6]])
                optional_header_list.append(['','' , "%04x"%(int("0x0800",16)), DllCharaEnt[6]])
            if dllChar & 0x1000:
                self.part3.append(['','' , "%04x"%(int("0x1000",16)), DllCharaEnt[7]])
                optional_header_list.append(['','' , "%04x"%(int("0x1000",16)), DllCharaEnt[7]])
            if dllChar & 0x2000:
                self.part3.append(['','' , "%04x"%(int("0x2000",16)), DllCharaEnt[8]])
                optional_header_list.append(['','' , "%04x"%(int("0x2000",16)), DllCharaEnt[8]])
            if dllChar & 0x4000:
                self.part3.append(['','' , "%04x"%(int("0x4000",16)), DllCharaEnt[9]])
                optional_header_list.append(['','' , "%04x"%(int("0x4000",16)), DllCharaEnt[9]])
            if dllChar & 0x8000:
                self.part3.append(['','' , "%04x"%(int("0x8000",16)), DllCharaEnt[10]])
                optional_header_list.append(['','' , "%04x"%(int("0x8000",16)), DllCharaEnt[10]])

            if BIT==32:
                self.part3.append([pFile(t), dWORD(hex(struct.unpack('<l', data[t:t+DWORD])[0])), 'Size of Stack Reverse', '']); 
                optional_header_list.append([pFile(t), dWORD(hex(struct.unpack('<l', data[t:t+DWORD])[0])), 'Size of Stack Reverse', ''])
                t+=DWORD
                self.part3.append([pFile(t), dWORD(hex(struct.unpack('<l', data[t:t+DWORD])[0])), 'Size of Stack Commit', '']); 
                optional_header_list.append([pFile(t), dWORD(hex(struct.unpack('<l', data[t:t+DWORD])[0])), 'Size of Stack Commit', ''])
                t+=DWORD
                self.part3.append([pFile(t), dWORD(hex(struct.unpack('<l', data[t:t+DWORD])[0])), 'Size of Heap Reverse', '']); 
                optional_header_list.append([pFile(t), dWORD(hex(struct.unpack('<l', data[t:t+DWORD])[0])), 'Size of Heap Reverse', ''])
                t+=DWORD 
                self.part3.append([pFile(t), dWORD(hex(struct.unpack('<l', data[t:t+DWORD])[0])), 'Size of Heap Commit', '']); 
                optional_header_list.append([pFile(t), dWORD(hex(struct.unpack('<l', data[t:t+DWORD])[0])), 'Size of Heap Commit', ''])
                t+=DWORD 
            elif BIT==64:
                self.part3.append([pFile(t), dWORD(hex(struct.unpack('<l', data[t:t+DWORD])[0])), 'Size of Stack Reverse', '']); 
                optional_header_list.append([pFile(t), dWORD(hex(struct.unpack('<l', data[t:t+DWORD])[0])), 'Size of Stack Reverse', ''])
            ...
            self.part3.append([pFile(t), dWORD(hex(struct.unpack('<l', data[t:t+DWORD])[0])), 'Loader Flags', '']); 
            optional_header_list.append([pFile(t), dWORD(hex(struct.unpack('<l', data[t:t+DWORD])[0])), 'Loader Flags', ''])
            t+=DWORD 
            self.part3.append([pFile(t), dWORD(hex(struct.unpack('<l', data[t:t+DWORD])[0])), 'Number of Data Directories', '']); 
            optional_header_list.append([pFile(t), dWORD(hex(struct.unpack('<l', data[t:t+DWORD])[0])), 'Number of Data Directories', ''])
            t+=DWORD 
            
            self.part4.append([pFile(t), dWORD(hex(struct.unpack('<l', data[t:t+DWORD])[0])), 'RVA', 'EXPORT Table']); 
            optional_header_list.append([pFile(t), dWORD(hex(struct.unpack('<l', data[t:t+DWORD])[0])), 'RVA', 'EXPORT Table'])
            t+=DWORD
            self.part4.append([pFile(t), dWORD(hex(struct.unpack('<l', data[t:t+DWORD])[0])), 'Size', '']); 
            optional_header_list.append([pFile(t), dWORD(hex(struct.unpack('<l', data[t:t+DWORD])[0])), 'Size', ''])
            t+=DWORD
            self.part4.append([pFile(t), dWORD(hex(struct.unpack('<l', data[t:t+DWORD])[0])), 'RVA', 'IMPORT Table']); 
            optional_header_list.append([pFile(t), dWORD(hex(struct.unpack('<l', data[t:t+DWORD])[0])), 'RVA', 'IMPORT Table'])
            t+=DWORD
            self.part4.append([pFile(t), dWORD(hex(struct.unpack('<l', data[t:t+DWORD])[0])), 'Size', '']); 
            optional_header_list.append([pFile(t), dWORD(hex(struct.unpack('<l', data[t:t+DWORD])[0])), 'Size', ''])
            t+=DWORD
            self.part4.append([pFile(t), dWORD(hex(struct.unpack('<l', data[t:t+DWORD])[0])), 'RVA', 'RESOURCE Table']); 
            optional_header_list.append([pFile(t), dWORD(hex(struct.unpack('<l', data[t:t+DWORD])[0])), 'RVA', 'RESOURCE Table'])
            t+=DWORD
            self.part4.append([pFile(t), dWORD(hex(struct.unpack('<l', data[t:t+DWORD])[0])), 'Size', '']); 
            optional_header_list.append([pFile(t), dWORD(hex(struct.unpack('<l', data[t:t+DWORD])[0])), 'Size', ''])
            t+=DWORD
            self.part4.append([pFile(t), dWORD(hex(struct.unpack('<l', data[t:t+DWORD])[0])), 'RVA', 'EXCEPTION Table']); 
            optional_header_list.append([pFile(t), dWORD(hex(struct.unpack('<l', data[t:t+DWORD])[0])), 'RVA', 'EXCEPTION Table'])
            t+=DWORD
            self.part4.append([pFile(t), dWORD(hex(struct.unpack('<l', data[t:t+DWORD])[0])), 'Size', '']); 
            optional_header_list.append([pFile(t), dWORD(hex(struct.unpack('<l', data[t:t+DWORD])[0])), 'Size', ''])
            t+=DWORD
            self.part4.append([pFile(t), dWORD(hex(struct.unpack('<l', data[t:t+DWORD])[0])), 'RVA', 'CERTIFICATE Table']); 
            optional_header_list.append([pFile(t), dWORD(hex(struct.unpack('<l', data[t:t+DWORD])[0])), 'RVA', 'CERTIFICATE Table'])
            t+=DWORD
            self.part4.append([pFile(t), dWORD(hex(struct.unpack('<l', data[t:t+DWORD])[0])), 'Size', '']); 
            optional_header_list.append([pFile(t), dWORD(hex(struct.unpack('<l', data[t:t+DWORD])[0])), 'Size', ''])
            t+=DWORD
            self.part4.append([pFile(t), dWORD(hex(struct.unpack('<l', data[t:t+DWORD])[0])), 'RVA', 'BASE RELOCATION Table']); 
            optional_header_list.append([pFile(t), dWORD(hex(struct.unpack('<l', data[t:t+DWORD])[0])), 'RVA', 'BASE RELOCATION Table'])
            t+=DWORD
            self.part4.append([pFile(t), dWORD(hex(struct.unpack('<l', data[t:t+DWORD])[0])), 'Size', '']); 
            optional_header_list.append([pFile(t), dWORD(hex(struct.unpack('<l', data[t:t+DWORD])[0])), 'Size', ''])
            t+=DWORD
            self.part4.append([pFile(t), dWORD(hex(struct.unpack('<l', data[t:t+DWORD])[0])), 'RVA', 'DEBUG Directoty']); 
            optional_header_list.append([pFile(t), dWORD(hex(struct.unpack('<l', data[t:t+DWORD])[0])), 'RVA', 'DEBUG Directoty'])
            t+=DWORD
            self.part4.append([pFile(t), dWORD(hex(struct.unpack('<l', data[t:t+DWORD])[0])), 'Size', '']); 
            optional_header_list.append([pFile(t), dWORD(hex(struct.unpack('<l', data[t:t+DWORD])[0])), 'Size', ''])
            t+=DWORD
            self.part4.append([pFile(t), dWORD(hex(struct.unpack('<l', data[t:t+DWORD])[0])), 'RVA', 'Architecture Specific Data']); 
            optional_header_list.append([pFile(t), dWORD(hex(struct.unpack('<l', data[t:t+DWORD])[0])), 'RVA', 'Architecture Specific Data'])
            t+=DWORD
            self.part4.append([pFile(t), dWORD(hex(struct.unpack('<l', data[t:t+DWORD])[0])), 'Size', '']); 
            optional_header_list.append([pFile(t), dWORD(hex(struct.unpack('<l', data[t:t+DWORD])[0])), 'Size', ''])
            t+=DWORD
            self.part4.append([pFile(t), dWORD(hex(struct.unpack('<l', data[t:t+DWORD])[0])), 'RVA', 'GLOBAL POINTER Register']); 
            optional_header_list.append([pFile(t), dWORD(hex(struct.unpack('<l', data[t:t+DWORD])[0])), 'RVA', 'GLOBAL POINTER Register'])
            t+=DWORD
            self.part4.append([pFile(t), dWORD(hex(struct.unpack('<l', data[t:t+DWORD])[0])), 'Size', '']); 
            optional_header_list.append([pFile(t), dWORD(hex(struct.unpack('<l', data[t:t+DWORD])[0])), 'Size', ''])
            t+=DWORD
            self.part4.append([pFile(t), dWORD(hex(struct.unpack('<l', data[t:t+DWORD])[0])), 'RVA', 'TLS Table']); 
            optional_header_list.append([pFile(t), dWORD(hex(struct.unpack('<l', data[t:t+DWORD])[0])), 'RVA', 'TLS Table'])
            t+=DWORD
            self.part4.append([pFile(t), dWORD(hex(struct.unpack('<l', data[t:t+DWORD])[0])), 'Size', '']); 
            optional_header_list.append([pFile(t), dWORD(hex(struct.unpack('<l', data[t:t+DWORD])[0])), 'Size', ''])
            t+=DWORD
            self.part4.append([pFile(t), dWORD(hex(struct.unpack('<l', data[t:t+DWORD])[0])), 'RVA', 'LOAD CONFIGURATION Table']); 
            optional_header_list.append([pFile(t), dWORD(hex(struct.unpack('<l', data[t:t+DWORD])[0])), 'RVA', 'LOAD CONFIGURATION Table'])
            t+=DWORD
            self.part4.append([pFile(t), dWORD(hex(struct.unpack('<l', data[t:t+DWORD])[0])), 'Size', '']); 
            optional_header_list.append([pFile(t), dWORD(hex(struct.unpack('<l', data[t:t+DWORD])[0])), 'Size', ''])
            t+=DWORD
            self.part4.append([pFile(t), dWORD(hex(struct.unpack('<l', data[t:t+DWORD])[0])), 'RVA', 'BOUND IMPORT Table']); 
            optional_header_list.append([pFile(t), dWORD(hex(struct.unpack('<l', data[t:t+DWORD])[0])), 'RVA', 'BOUND IMPORT Table'])
            t+=DWORD
            self.part4.append([pFile(t), dWORD(hex(struct.unpack('<l', data[t:t+DWORD])[0])), 'Size', '']); 
            optional_header_list.append([pFile(t), dWORD(hex(struct.unpack('<l', data[t:t+DWORD])[0])), 'Size', ''])
            t+=DWORD
            self.part4.append([pFile(t), dWORD(hex(struct.unpack('<l', data[t:t+DWORD])[0])), 'RVA', 'IMPORT Address Table']); 
            optional_header_list.append([pFile(t), dWORD(hex(struct.unpack('<l', data[t:t+DWORD])[0])), 'RVA', 'IMPORT Address Table'])
            t+=DWORD
            self.part4.append([pFile(t), dWORD(hex(struct.unpack('<l', data[t:t+DWORD])[0])), 'Size', '']); 
            optional_header_list.append([pFile(t), dWORD(hex(struct.unpack('<l', data[t:t+DWORD])[0])), 'Size', ''])
            t+=DWORD
            self.part4.append([pFile(t), dWORD(hex(struct.unpack('<l', data[t:t+DWORD])[0])), 'RVA', 'Delay IMPORT Descriptors']); 
            optional_header_list.append([pFile(t), dWORD(hex(struct.unpack('<l', data[t:t+DWORD])[0])), 'RVA', 'Delay IMPORT Descriptors'])
            t+=DWORD
            self.part4.append([pFile(t), dWORD(hex(struct.unpack('<l', data[t:t+DWORD])[0])), 'Size', '']); 
            optional_header_list.append([pFile(t), dWORD(hex(struct.unpack('<l', data[t:t+DWORD])[0])), 'Size', ''])
            t+=DWORD
            self.part4.append([pFile(t), dWORD(hex(struct.unpack('<l', data[t:t+DWORD])[0])), 'RVA', 'CLI Header']); 
            optional_header_list.append([pFile(t), dWORD(hex(struct.unpack('<l', data[t:t+DWORD])[0])), 'RVA', 'CLI Header'])
            t+=DWORD
            self.part4.append([pFile(t), dWORD(hex(struct.unpack('<l', data[t:t+DWORD])[0])), 'Size', '']); 
            optional_header_list.append([pFile(t), dWORD(hex(struct.unpack('<l', data[t:t+DWORD])[0])), 'Size', ''])
            t+=DWORD
            self.part4.append([pFile(t), '00000000', 'RVA', '']); 
            optional_header_list.append([pFile(t), '00000000', 'RVA', ''])
            t+=DWORD
            self.part4.append([pFile(t), '00000000', 'Size', '']); 
            optional_header_list.append([pFile(t), '00000000', 'Size', ''])
            t+=DWORD
            t-=(DWORD*32)
            for i in range(0, 15):
...
class SectionHeader:
    ...
    def __init__(self, t, SecNumber):   
        ...
        for i in range(0, SecNumber):
            ...
            sec_list.append([pFile(t), dWORD(hex(struct.unpack('<l', data[t:t+DWORD])[0])), 
                           'Name', (data[t:t+DWORD].decode('ISO-8859-1') + data[t+DWORD:t+DWORD*2].decode('ISO-8859-1'))]); t+=DWORD
            sec_list.append([pFile(t), dWORD(hex(struct.unpack('<l', data[t:t+DWORD])[0])), '', '']); t+=DWORD
            sec_list.append([pFile(t), dWORD(hex(struct.unpack('<l', data[t:t+DWORD])[0])), 
            ...
            sec_list.append([pFile(t), wORD(hex(struct.unpack('<l', data[t:t+WORD]+b'\x00\x00')[0])), 
            ...
            if flag & 0x00000020:
                sec_list.append(['','' , "%08x"%(int("00000020",16)), charType[0]])
            if flag & 0x00000040:
                sec_list.append(['','' , "%08x"%(int("00000040",16)), charType[1]])
            if flag & 0x00000080:
                sec_list.append(['','' , "%08x"%(int("00000080",16)), charType[2]])
            if flag & 0x02000000:
                sec_list.append(['','' , "%08x"%(int("02000000",16)), charType[3]])  
            if flag & 0x04000000:
                sec_list.append(['','' , "%08x"%(int("04000000",16)), charType[4]])  
            if flag & 0x08000000:
                sec_list.append(['','' , "%08x"%(int("08000000",16)), charType[5]])
            if flag & 0x10000000:
                sec_list.append(['','' , "%08x"%(int("10000000",16)), charType[6]])  
            if flag & 0x20000000:
                sec_list.append(['','' , "%08x"%(int("20000000",16)), charType[7]])  
            if flag & 0x40000000:
                sec_list.append(['','' , "%08x"%(int("40000000",16)), charType[8]])  
            if flag & 0x80000000:
                sec_list.append(['','' , "%08x"%(int("80000000",16)), charType[9]])  
            self.part.append(sec_list)
    ...
    def BoundedIDT(self):
        ...
        while True:
            ...
            subPart.append([pFile(t), dWORD(hex(struct.unpack('<l', data[t:t+DWORD])[0])), 
                            'Time Date Stamp', BuildTime]); 
            bt_list.append([pFile(t), dWORD(hex(struct.unpack('<l', data[t:t+DWORD])[0])), 
                            'Time Date Stamp', BuildTime])
            t+=DWORD
            if byteToInt(data[t:t+DWORD]) == 0:
                subPart.append([pFile(t), '', '', '']); 
                bt_list.append([pFile(t), '', '', ''])
                t+=WORD
            ...
            subPart.append([pFile(t), wORD(hex(struct.unpack('<l', data[t:t+WORD]+b'\x00\x00')[0])), 
                            'Offset to Module Name', data[dllStart:address].decode('ISO-8859-1')]); 
            bt_list.append([pFile(t), wORD(hex(struct.unpack('<l', data[t:t+WORD]+b'\x00\x00')[0])), 
                            'Offset to Module Name', data[dllStart:address].decode('ISO-8859-1')])                
            t+=WORD
            subPart.append([pFile(t), wORD(hex(struct.unpack('<l', data[t:t+WORD]+b'\x00\x00')[0])), 
                            'Number of Module Forwarded Refs', '']); 
            bt_list.append([pFile(t), wORD(hex(struct.unpack('<l', data[t:t+WORD]+b'\x00\x00')[0])), 
                            'Number of Module Forwarded Refs', ''])                
            t+=WORD
            self.part.append(subPart)
            bt_list.append(subPart)
...
class ImportTable:
    def __init__(self, offset, size, secRva, pToRawData):
        ...
        while t < offset+size:
            ...
            sec_import_directory_table.append(self.part1)
            count+=1
        intRvaList.sort()
        iatRvaList.sort()
...
class ImportNameTable:
    def __init__(self, rva, pToRawData):
        ...
        for i in intRvaList:
                ...
                import_name_table.append(self.tempPart)
...
class ImportAddressTable:
    def __init__(self, rva, pToRawData):
        ...
        for i in iatRvaList:
                ...
                count +=1
                self.tempPart.append(subPart)
                import_address_table.append(self.tempPart)
...
class ImportHintsAndNames:
    def __init__(self, rva, pToRawData):
        ...
        import_hint_and_names.append(self.info)
...
class debugDirectory:
    def __init__(self, offset, size): #TimeDataStamp, Type
        ...
        while True:
            ...
            self.part1.append(subPart)
            image_debug_directory.append(self.part1)
    ...
    def __init__(self, offset, size):
        ...
        if dllChar & 0x4000 == 0x4000:
            ...
            if BIT==64:
                ...
                self.part1.append([pFile(t), dWORD(hex(struct.unpack('<l', data[t:t+DWORD])[0])), 'Guard CF Function Count', '']); t+=DWORD
                self.part1.append([pFile(t), '', '', '']); t+=DWORD
            self.part1.append([pFile(t), dWORD(hex(struct.unpack('<l', data[t:t+DWORD])[0])), 'Guard Flags', '']); 
            image_load_config_directory.append(self.part1)
            t+=DWORD
...
# f = open("C:\\Users\\lisas\\Desktop\\DEBUG\\프젝 도구\\notepad.exe", 'rb')
